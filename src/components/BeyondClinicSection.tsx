    ...
    <section className="bg-white py-20 px-8">
      <div className="max-w-[1280px] mx-auto">
        <motion.div
          ...
          className="bg-[#fafafa] rounded-3xl p-16 flex gap-12 items-center"
        >
          {/* Image grid */}
          <motion.div
          ...
          >
            <motion.p
              ...
              className="font-figtree font-bold text-primary text-[14px] tracking-[1.4px] uppercase"
            >
              Beyond the Clinic
            </motion.p>
            ...
            <motion.h3
              variants={fadeInRight}
              className="font-junge text-[36px] text-[#1f2937] leading-[40px]"
            >
            ...
            <motion.p
              variants={fadeInUp}
              className="font-figtree text-[16px] text-[#6b7280] leading-[26px] pt-4"
            >
            ...
            <motion.p
              variants={fadeInUp}
              className="font-figtree text-[16px] text-[#6b7280] leading-[26px]"
            >
